...
export const creditBenefits = [
  <>
    Each consultation requires{" "}
    <strong className="text-emerald-400">2 credits</strong> regardless
    of duration
  </>,
  <>
    Credits <strong className="text-emerald-400">never expire</strong>{" "}
    — use them whenever you need
  </>,
  <>
    Monthly subscriptions give you{" "}
  ...
  <>
    ...
    <strong className="text-emerald-400">anytime</strong> without
    penalties
  </>,
];
