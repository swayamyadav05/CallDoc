        ...
        <Card className={"border-emerald-900/20"}>
          <CardHeader className={"text-center"}>
            ...
            <CardDescription className={"text-lg"}>
              {isRejected
                ? "Unfortunately, your form needs revision"
          ...
          <CardContent>
            {isRejected ? (
              <div className="bg-red-900/10 border border-red-900/20 rounded-lg p-4 mb-6 flex items-start">
                ...
                <div className="text-muted-foreground text-left">
                  <p className="mb-2">
                    ...
                    application and found that it doesn&apos;t meet
                    our current requirements. Common reasons for
                    rejection include:
                  </p>
                  ...
                  <p>
                    You can update your application with more
                    information and resubmit for review again.
                  </p>
                </div>
              </div>
            ) : (
              <div className="bg-amber-900/10 border border-amber-900/20 rounded-lg p-4 mb-6 flex items-start">
                ...
                <p className="text-muted-foreground text-left">
                  ...
                  administrative team. This process typically takes
                  1-2 business days. You&apos;ll receive an email
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                ...
                variant="outline"
                className={
                  "!bg-emerald-900/30 hover:!bg-emerald-900/40 !border-emerald-900/30"
                }>
